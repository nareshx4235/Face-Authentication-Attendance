...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # Creating Frame 
        main_frame = Frame(bg_img,bd=10,bg="white") #bd mean border 
        main_frame.place(x=45,y=160,width=1820,height=800)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=10,bg="white",relief=RIDGE,text="Student Details",font=("verdana",20,"bold"),fg="navyblue")
        left_frame.place(x=10,y=10,width=880,height=700)
        ...
        studentId_label.grid(row=0,column=0,padx=5,pady=10)
        ...
        student_roll_label.grid(row=0,column=2,padx=15,pady=5)

        student_roll_entry = ttk.Entry(left_frame,textvariable=self.var_roll,width=15,font=("verdana",12,"bold"))
        student_roll_entry.grid(row=0,column=3,padx=5,pady=5)
        ...
        date_label.grid(row=2,column=0,padx=15,pady=5,sticky=W)
        ...
        table_frame.place(x=10,y=170,width=840,height=480)
        ...
        btn_frame.place(x=20,y=550,width=800,height=60)
        ...
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",20,"bold"),fg="navyblue")
        right_frame.place(x=900,y=10,width=880,height=700)
        ...
        table_frame.place(x=10,y=90,width=850,height=550)
    ...
    #Update button
        del_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",15,"bold"),fg="white",bg="navyblue")
        del_btn.grid(row=0,column=1,padx=15,pady=15,sticky=W)
    #delete button
        del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",15,"bold"),fg="white",bg="navyblue")
        del_btn.grid(row=0,column=2,padx=15,pady=15,sticky=W)
