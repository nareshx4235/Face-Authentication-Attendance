...
class Face_Recognition:
    def __init__(self, root):
        ...
        #button
        Button_btn1= Button(f_lbl, text="Face Recognition",command=self.face_recog, font=("arial",18,"bold"), bg= "darkgreen", fg="white")
        ...
        def draw_boundary(img, classifier,scaleFactor,minNeighbours,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                if confidence>77: 
                    ...
                    cv2.putText(img, f"Unknown Face",(x,y-20),cv2.FONT_HERSHEY_SIMPLEX,0.8,(255,255,255),2)
